...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, ar.edu.um.isa.oncall.domain.AsignacionDeAccion.class.getName());
            createCache(cm, ar.edu.um.isa.oncall.domain.RecordatorioDeAccion.class.getName());
            createCache(cm, ar.edu.um.isa.oncall.domain.CierreDeAccion.class.getName());
