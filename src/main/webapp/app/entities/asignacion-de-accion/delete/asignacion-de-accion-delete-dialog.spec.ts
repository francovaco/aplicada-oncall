...
import { AsignacionDeAccionDeleteDialog } from './asignacion-de-accion-delete-dialog';

describe('AsignacionDeAccion Management Delete Component', () => {
  let comp: AsignacionDeAccionDeleteDialog;
  let fixture: ComponentFixture<AsignacionDeAccionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AsignacionDeAccionDeleteDialog);
