...
import { CierreDeAccionDeleteDialog } from './cierre-de-accion-delete-dialog';

describe('CierreDeAccion Management Delete Component', () => {
  let comp: CierreDeAccionDeleteDialog;
  let fixture: ComponentFixture<CierreDeAccionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CierreDeAccionDeleteDialog);
