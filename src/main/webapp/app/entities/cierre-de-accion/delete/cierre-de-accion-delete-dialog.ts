...
@Component({
  ...
  templateUrl: './cierre-de-accion-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class CierreDeAccionDeleteDialog {
  cierreDeAccion?: ICierreDeAccion;
  ...
  confirmDelete(id: number): void {
    this.cierreDeAccionService.delete(id).subscribe(() => {
