...
import { RecordatorioDeAccionDeleteDialog } from './recordatorio-de-accion-delete-dialog';

describe('RecordatorioDeAccion Management Delete Component', () => {
  let comp: RecordatorioDeAccionDeleteDialog;
  let fixture: ComponentFixture<RecordatorioDeAccionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RecordatorioDeAccionDeleteDialog);
