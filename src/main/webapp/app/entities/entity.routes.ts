...
const routes: Routes = [
  ...
  {
    path: 'asignacion-de-accion',
    data: { pageTitle: 'oncallApp.asignacionDeAccion.home.title' },
    loadChildren: () => import('./asignacion-de-accion/asignacion-de-accion.routes'),
  },
  {
    path: 'recordatorio-de-accion',
    data: { pageTitle: 'oncallApp.recordatorioDeAccion.home.title' },
    loadChildren: () => import('./recordatorio-de-accion/recordatorio-de-accion.routes'),
  },
  {
    path: 'cierre-de-accion',
    data: { pageTitle: 'oncallApp.cierreDeAccion.home.title' },
    loadChildren: () => import('./cierre-de-accion/cierre-de-accion.routes'),
  },
  {
